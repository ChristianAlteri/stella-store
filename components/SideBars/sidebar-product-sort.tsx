...
interface SideBarProductSortProps {
  categoryData?: Category;
  productData?: Product[];
  genders?: Gender[];
}

const SideBarProductSort: React.FC<SideBarProductSortProps> = ({
  categoryData,
  productData,
  genders,
}) => {
  ...
  return (
    <div className="flex-col justify-center items-center p-2 shadow-2xl rounded-md w-full  h-full border hidden md:flex">
      <div className="flex flex-col items-center p-4 shadow-lg rounded-md w-full h-full">
        ...
        {filtersOpen && (
          <div className="flex flex-col gap-12 justify-between items-between w-full p-1 overflow-x-auto">
            <AllSortFilters
              data={productData}
            />
          </div>
...
export default SideBarProductSort;
