...
const FilterButtons: React.FC<FilterButtonsProps> = ({ data, name, valueKey }) => {
    ...
    return ( 
        <div className="flex flex-row items-start justify-start text-start">
            <div className="flex w-full flex-row items-center gap-4 ">
                ...
                {!isExpanded && (
                    <h3 className="text-xs hover:underline hover:cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                        {name}
                    </h3>
                )}
